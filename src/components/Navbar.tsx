const Navbar = () => {
  return (
    <header className='bg-purple-800 h-full md:h-[80px] py-5 md:py-0'>
      <nav className='h-full flex flex-col md:flex-row md:justify-between items-center px-10 gap-2'>
        ...
        <a href='http://www.github.com/devxyn' className='text-xs text-white' target='_blank' rel='noopener noreferrer'>
